<footer class="bg-light text-center text-lg-start mt-4 " id="foot">
    ...
    <div class="row">
      ...
      <div class="col-lg-12 col-md-12 mb-4 mb-md-0" style="background-color: rgba(0, 0, 0, 0.2)">
        ...
        <p>
          ...
          <a href="https://es.wikipedia.org/wiki/Pulp_(literatura)" target="_blank">Saber más</a>
  ...
  <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
    © 2021 Copyright: Juan Antonio Guillo Lopez
  </div>
